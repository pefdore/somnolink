// src/app/dashboard/doctor/patients/[patientId]/consultation/suivi-annuel/page.tsx
...
export default async function SuiviAnnuelPage({ params }: { params: { patientId: string } }) {
