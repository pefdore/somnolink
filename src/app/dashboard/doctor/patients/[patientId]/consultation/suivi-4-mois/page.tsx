// src/app/dashboard/doctor/patients/[patientId]/consultation/suivi-4-mois/page.tsx
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 p-6 bg-white border-l border-gray-200">
        <ConsultationTabs patientId={patientId} doctorId={doctor.id} consultationType="suivi-4-mois" />
      </div>
    </div>
  );
}