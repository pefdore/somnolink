// src/app/dashboard/doctor/patients/[patientId]/consultation/pose-machine/page.tsx
...
export default async function PoseMachinePage({ params }: { params: { patientId: string } }) {
  ...
  return (
    <div className="flex h-full">
      ...
      <div className="flex-1 p-6 bg-white border-l border-gray-200">
        <ConsultationTabs patientId={patientId} doctorId={doctor.id} consultationType="pose-machine" />
      </div>
    </div>
  );
}