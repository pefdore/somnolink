...
const formSchema = z.object({
  ...
  life_habits: z.record(z.string(), z.unknown()).optional().default({}),
  driving_info: z.record(z.string(), z.unknown()).optional().default({}),
  sleep_disorder_history: z.record(z.string(), z.unknown()).optional().default({}),
